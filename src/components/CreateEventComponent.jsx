...
class CreateEventComponent extends Component {
    ...
    saveOrUpdateEvent = (e) => {
        e.preventDefault();
        let booking = {name: this.state.name, eventName: this.state.eventName, date: this.state.date,duration:this.state.duration,starttime:this.state.starttime,contact:this.state.contact,place:this.state.place};
        console.log('booking => ' + JSON.stringify(booking));
       // if(this.state.bookingId === '_add'){
  
            EventService.createEvent(booking).then(res =>{
                this.props.history.push('/');
            });
            alert("Successfully added");
       // }else{
        //    EventService.updateEvent(booking, this.state.bookingId).then( res => {
